...
class TestRequestInsert(unittest.TestCase):
    ...
    def test__cast_to_bytes(self):
        ...
        """
        self.assertEqual(
            bytes(RequestInsert(charset, errors, 1, 0, 1, 2000, 30000)),
            binascii.unhexlify("0d0000001b00000000000000010000000000000003000000040100000004d00700000430750000")
        )

        self.assertEqual(
            bytes(RequestInsert(charset, errors, 1, 0, b"AAA", b"BBBB", b"CCCCCC")),
...
class TestRequestDelete(unittest.TestCase):
    ...
    def test__cast_to_bytes(self):
        ...
        """
        self.assertEqual(
            bytes(RequestDelete(charset, errors, 1, 0, 1)),
            binascii.unhexlify("1500000011000000000000000100000000000000010000000401000000")
        )

        self.assertEqual(
            bytes(RequestDelete(charset, errors, 1, 0, b"AAA")),
...
class TestRequestSelect(unittest.TestCase):
    ...
    def test__cast_to_bytes(self):
        ...
        self.assertEqual(
            bytes(RequestSelect(charset, errors, 1, 0, 0, 0xffff, (1,))),
        ...
        self.assertEqual(
            bytes(RequestSelect(charset, errors, 1, 0, 0, 0xffff, (b"AAA",))),
        ...
        self.assertEqual(
            bytes(RequestSelect(charset, errors, 1, 0, 0, 0xffff, (1,), (2,), (3,))),
        ...
        self.assertEqual(
            bytes(RequestSelect(charset, errors, 1, 0, 0, 0xffff, (1, 2))),
        ...
        self.assertEqual(
            bytes(RequestSelect(charset, errors, 1, 0, 0, 0xffff, (1, 2), (3, 4))),
...
class TestRequestUpdate(unittest.TestCase):
    ...
    def test__cast_to_bytes(self):
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (0x22,), [(0x33, '=', 0x11223344)])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (b"ZZZZZZ",), [(0x33, '=', 0x11223344)])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (0x22,), [(0x33, '=', b"NNN")])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (b"ZZZZZZ",), [(0x33, '=', b"NNN")])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (0x22,), [(0x33, '=', 0x3333), (0x44, '=', 0x4444), (0x55, '=', 0x5555)])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, ("ZZZZZZ",), [(0x33, '=', 0x3333), (0x44, '=', 0x4444), (0x55, '=', 0x5555)])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (0x22,), [(0x33,'=', b"KKK"), (0x44,'=', b"LLL"), (0x55,'=', b"MMM")])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (b"ZZZZZZ",), [(0x33,'=', b"KKK"), (0x44,'=', b"LLL"), (0x55,'=', b"MMM")])),
        ...
        self.assertEqual(
            bytes(RequestUpdate(charset, errors, 0x11, 0, (0x22,), [(0x33, '+', 0x55)])),
